...
Your task is to write a *Quantitative Analysis* section suitable for an investment report, using Yahoo Finance tools for market data and an Ephemeral Cloud Based Code Interpreter that has no memory or internet access for analysis and plotting.
